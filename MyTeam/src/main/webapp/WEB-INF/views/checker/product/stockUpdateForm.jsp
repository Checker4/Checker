...
<div class="section-block">
    <div class="container">
        <div>
	        <h1>상품 수정</h1>
	        <hr>
	        <form action="<%=contextPath %>/product/stockUpdate" method="post">
	        	<input type="hidden" name="product_code" value="${ProductDto.product_code}">
	        	<input type="hidden" name="product_create_date" value="${ProductDto.product_create_date}">
		        <table>
					<tr>
						<th>상품명</th>
					...
					<tr>
						<th>용량</th>
						<td><input type="text" name="product_size" value="${ProductDto.product_size}" required class="input_class"></td>
					</tr>
					<tr>
						<th>설명</th>
